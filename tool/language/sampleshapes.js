...
joint.shapes.istar.Goal = joint.shapes.basic.Path.extend({
    ...
    defaults: joint.util.deepSupplement({
        ...
        attrs: {
            'path': {
                d: 'M -40,20 -40,70 60,70 80,100 150,100 170,70 250,70 250,40 220,20 260,-40 200,-50 170,-30 150,-75 80,-60 80,-30 30,-75 -20,-60 0,0 -40,20',
                fill: 'rgb(205,254,205)',
                resetOffset: true,
                stroke: 'black',
                'stroke-width': 2,
...
//     context.fill = 'green';
// };
// joint.shapes.istar.Task = joint.shapes.standard.Circle.extend({
//     markup: '<g class="scalable"><circle class="element"/></g><text class="content"/>',
//     defaults: joint.util.deepSupplement({
//         type: 'Task',
...
joint.shapes.istar.Task = joint.shapes.basic.Path.extend({
    markup: '<g class="scalable"><path class="element"/></g><text class="content"/>',
    defaults: joint.util.deepSupplement({
        type: 'Task',
        size: {width: 90, height: 55},
        attrs: {
            'path': {
                d: 'M -40,20 -40,70 60,70 80,100 150,100 170,70 250,70 250,40 220,20 260,-40 200,-50 170,-30 150,-75 80,-60 80,-30 30,-75 -20,-60 0,0 -40,20',
                // d: 'M 0,0 10,10 C 20 0 20 20 10 20 20 L 0,0 20 20 15 Z',
...
// joint.shapes.basic.Polygon.extend({
