...
istar.models.pistarWelcome = {
    "actors": [
        ...
        // },
        {
            ...
            "y": 16,
            "customProperties": {
                "Description": "the graph needs to be created inside this container"
            },
            "nodes": [
                {
                    ...
                    "y": 49,
                    "customProperties": {
                        "Description": "The main softgoal of an NFR"
                    }
                },
                {
                    "id": "71c7aeb6-fb99-40a1-bcd1-5a29e5b45250",
                    "text": "Cognition",
                    "type": "istar.Goal",
                    "x": 100,
                    "y": 130,
                ...
                {
                    "id": "71c7aeb6-fb99-40a1-bcd1-5a29e5b45251",
                    "text": "Operability",
                    "type": "istar.Goal",
                    "x": 210,
                    "y": 130,
                ...
                },
                {
                    ...
                    "text": "Provide user friendly interface with feedback",
                    "type": "istar.Task",
                    "x": 42,
                    "y": 261,
                    "customProperties": {
                        "Description": "this is the operationalization task"
                    }
                },
                // {
                ...
                // },
                {
                    ...
                    "text": "Provide the user with control over accessibility",
                    "type": "istar.Task",
                    "x": 170,
                    "y": 265,
                    "customProperties": {
                ...
                {
                    "id": "8cc94931-99dd-441e-bf97-9b08c03ae570",
                    "text": "Provide control panel with flexibility to input information",
                    "type": "istar.Task",
                    "x": 370,
                    "y": 311,
                    "customProperties": {
                ...
                {
                    "id": "8cc94931-99dd-441e-bf97-9b08c03ae571",
                    "text": "Provide control about the font size in panel control",
                    "type": "istar.Task",
                    "x": 110,
                    "y": 381,
                    "customProperties": {
                ...
                {
                    "id": "8cc94931-99dd-441e-bf97-9b08c03ae572",
                    "text": "Provide volume control panel for the control panel beeps",
                    "type": "istar.Task",
                    "x": 240,
                    "y": 381,
                    "customProperties": {
                ...
                {
                    "id": "8cc94931-99dd-441e-bf97-9b08c03ae573",
                    "text": "Allow user to create alias for configuration",
                    "type": "istar.Task",
                    "x": 350,
                    "y": 450,
                    "customProperties": {
                ...
                {
                    "id": "8cc94931-99dd-441e-bf97-9b08c03ae574",
                    "text": "Allow voice control",
                    "type": "istar.Task",
                    "x": 490,
                    "y": 450,
                    "customProperties": {
                ...
                {
                    "id": "8cc94931-99dd-441e-bf97-9b08c03ae575",
                    "text": "Provide interface with users feedback",
                    "type": "istar.Task",
                    "x": 390,
                    "y": 81,
                    "customProperties": {
                ...
                },
                {
                    ...
                    "text": "Provide GUI with sensors data",
                    "type": "istar.Task",
                    "x": 370,
                    "y": 191,
                    "customProperties": {
                ...
                {
                    "id": "8cc94931-99dd-441e-bf97-9b08c03ae577",
                    "text": "Provide tactile interfaces",
                    "type": "istar.Task",
                    "x": 500,
                    "y": 191,
                    "customProperties": {
    ...
    "links": [
        {
            //Cognition to Usability
            "id": "6c57baea-e769-4fa5-a19d-6b12eecdb7cd",
            "type": "istar.OrRefinementLink",
            "source": "71c7aeb6-fb99-40a1-bcd1-5a29e5b45250",
            "target": "71c7aeb6-fb99-40a1-bcd1-5a29e5b45252"
        },
        {
            //Operability to Usability
            "id": "6c57baea-e769-4fa5-a19d-6b12eecdb7c0",
            "type": "istar.OrRefinementLink",
            "source": "71c7aeb6-fb99-40a1-bcd1-5a29e5b45251",
            "target": "71c7aeb6-fb99-40a1-bcd1-5a29e5b45252"
        },
        {
            //Allow user to create alias for custom configuration to provide control panel with flexibility to input info
            "id": "6c57baea-e769-4fa5-a19d-6b12eecdb7c1",
            "type": "istar.OrRefinementLink",
            "source": "8cc94931-99dd-441e-bf97-9b08c03ae573",
            "target": "8cc94931-99dd-441e-bf97-9b08c03ae570"
        },
        {
            // Allow voice control to provide control panel with flexibility to input info
            "id": "6c57baea-e769-4fa5-a19d-6b12eecdb7c2",
            "type": "istar.OrRefinementLink",
            "source": "8cc94931-99dd-441e-bf97-9b08c03ae574",
            "target": "8cc94931-99dd-441e-bf97-9b08c03ae570"
        },
        {
            // Control about the font size in panel control to provide the user with control over accessibility definitions
            "id": "6c57baea-e769-4fa5-a19d-6b12eecdb7c3",
            "type": "istar.OrRefinementLink",
            "source": "8cc94931-99dd-441e-bf97-9b08c03ae571",
            "target": "ab3313df-175f-4b2b-9486-c0915a3d1cd4"
        },
        {
            // Provide volume control for the control panel beeps to provide the user with control over accessibility definitions
            "id": "6c57baea-e769-4fa5-a19d-6b12eecdb7c4",
            "type": "istar.OrRefinementLink",
            "source": "8cc94931-99dd-441e-bf97-9b08c03ae572",
            "target": "ab3313df-175f-4b2b-9486-c0915a3d1cd4"
        },
        {
            //Provide GUI with sensors data to provide interface with user feedbacks
            "id": "933bf752-403a-4625-9216-980d6134e824",
            "type": "istar.AndRefinementLink",
            "source": "8cc94931-99dd-441e-bf97-9b08c03ae576",
            "target": "8cc94931-99dd-441e-bf97-9b08c03ae575"
        },
        {
            //Provide tactile interfaces to provide interface with users feedbacks
            "id": "b6f44d15-563d-4b1c-99cc-355ab6f49691",
            "type": "istar.AndRefinementLink",
            "source": "8cc94931-99dd-441e-bf97-9b08c03ae577",
            "target": "8cc94931-99dd-441e-bf97-9b08c03ae575"
        },
        {
            //provide user friendly interface with feedback for user action to cognition
            "id": "5bc05a64-fcca-4eba-9f8b-f19e43773ff0",
            "type": "istar.ContributionLink",
            "source": "8d716a61-1ca4-44f4-934c-26166ea44d11",
            "target": "71c7aeb6-fb99-40a1-bcd1-5a29e5b45250",
            "label": "make"
        },
        {
            //control over accessibility to operability
            "id": "5c3a554c-5988-48ec-b2c7-293b8e1db746",
            "type": "istar.ContributionLink",
            "source": "ab3313df-175f-4b2b-9486-c0915a3d1cd4",
            "target": "71c7aeb6-fb99-40a1-bcd1-5a29e5b45251",
            "label": "help"
        },
        {
            // control panel with flexibility to input info to operability
            "id": "4cb02d7c-a150-4e81-b340-26fa8fab9899",
            "type": "istar.ContributionLink",
            "source": "8cc94931-99dd-441e-bf97-9b08c03ae570",
            "target": "71c7aeb6-fb99-40a1-bcd1-5a29e5b45251",
            "label": "help"
        },
        {
            // interface with user feedbacks to operability
            "id": "5c3a554c-5988-48ec-b2c7-293b8e1db746",
            "type": "istar.ContributionLink",
            "source": "8cc94931-99dd-441e-bf97-9b08c03ae575",
            "target": "71c7aeb6-fb99-40a1-bcd1-5a29e5b45251",
            "label": "help"
        },
        {
